...
class Toplist_Controller extends Template_Controller
{
	...
	*/
	...
	function vote( $type, $toplist_id = null )
	{
		...
		// se la toplist non esiste o Ã¨ inactive, errore
		...
		////////////////////////////////////////////////////////////////////
		// se il giocatore ha giÃ  effettuato 3 voti per tipo, stop al voto
		////////////////////////////////////////////////////////////////////
		...
		// Se la toplist_id Ã¨ nulla, visualizzo le toplist
	...
	*/
	...
	function reward()
	{
		...
		// se il voto non Ã¨ immediato ci aspettiamo
