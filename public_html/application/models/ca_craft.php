ï»¿<?php defined('SYSPATH') OR die('No direct access allowed.');

class CA_Craft_Model extends Character_Action_Model
{
	
	// Punti sazietÃ  necessari per un'ora di lavoro
	...
	*/
	...
	protected function check( $par, &$message )
	{
		...
		// se la struttura Ã¨ locked, puÃ² cragtare solo bread.
		...
		//////////////////////////////////////////////////////////////////////
		// Controllo, se il moltiplicatore Ã¨ > 1, il char deve avere il bonus
		//////////////////////////////////////////////////////////////////////
		...
		//////////////////////////////////////////////////////////////////////
		// Controllo, se l' item Ã¨ craftabile con questo tipo di negozio		
		//////////////////////////////////////////////////////////////////////
		...
		// Chekc: il char non ha abbastanza sazietÃ 
		// Il calcolo di energia e sazietÃ  viene eseguito su base oraria
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////
		// se l' inventario della struttura è piena, non si puÃ² craftare		
		/////////////////////////////////////////////////////////////////////////////////////////////////
